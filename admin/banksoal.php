								...
								<?php while ($mapel = mysqli_fetch_array($mapelQ)) : ?>
									...
									<tr>
										...
										<td>
											...
											?>
											<img src="<?= $homeurl ?>/dist/img/soal.png" width=45 alt="">
							...
							<div class='row'>
								...
								<div class='col-md-4'>
									...
									<select name='agama' class='form-control'>
										<option value=''>Bukan Soal Agama</option>
										<?php
										$agam = mysqli_fetch_all(mysqli_query($koneksi, "SELECT agama FROM siswa group by agama"), MYSQLI_ASSOC);

										foreach ($agam as $key => $agama) {
											echo "<option value='" . $agama['agama'] . "' $s>$agama[agama]</option>";
										}
										?>
									</select>
					...
					<div class='nav-tabs-custom'>
						...
						<div class='tab-content'>
							...
							<div class='tab-pane' id='materi'>
								...
								<!-- Modal -->
								<div class="modal fade" id="modelId" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="overflow: auto !important;">
