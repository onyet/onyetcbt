        ...
        <div class='col-md-12'>
            <div class='box box-solid'>
                ...
                <div class='box-body'>
                    ...
                    <!-- Modal -->
                    <div class="modal fade" id="modaltugas" tabindex="-1" role="dialog" aria-labelledby="modelTitleId" aria-hidden="true" style="overflow: auto !important;">
                                        ...
                                        <td>
                                            <?php if ($tugas['file'] <> null) { ?>
                                                <?php  if(isset($_SESSION['is_mobile'])) { ?>
                                                    <a href="<?= $homeurl ?>/admin/index.php?pg=viewer&file=<?= urlencode($homeurl .'/berkas/'. $tugas['file']) ?>">Lihat</a>
                                                <?php } else { ?>
                                                    <a href="<?= $homeurl ?>/berkas/<?= $tugas['file'] ?>">Lihat</a>
                                                <?php } ?>
                                            <?php } ?>
                                        </td>
                                        <td style="text-align:center">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td><?= substr(strip_tags($jawab['jawaban']),0,30) ?></td>
                                        <td>
                                            <?php if ($jawab['file'] <> null) { ?>
                                                <?php  if(isset($_SESSION['is_mobile'])) { ?>
                                                    <a href="<?= $homeurl ?>/admin/index.php?pg=viewer&file=<?= urlencode($homeurl .'/tugas/'. $jawab['file']) ?>">Lihat</a>
                                                <?php } else { ?>
                                                    <a href="<?= $homeurl ?>/tugas/<?= $jawab['file'] ?>">Lihat</a>
                                                <?php } ?>
                                            <?php } else {
                                                echo 'Tidak Ada.';
                                            } ?>
                                        </td>
                                        <td><?= ($jawab['nilai'] <> null) ? $jawab['nilai'] : 'Belum Ada' ?></td>
